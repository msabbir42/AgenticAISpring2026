...
def decide_whether_to_print(env_var_name: str, default_value: bool = False) -> bool:
    ...
    # Get the value of the environment variable, or use the default if not set
    env_value = os.getenv(env_var_name, str(default_value))

    # Convert to boolean: treat "true", "1", "yes" (case-insensitive) as True
    return env_value.lower() == "verbose"
...
def create_graph(llm):
    ...
    def get_user_input(state: AgentState) -> dict:
        ...
        print("\n" + "=" * 50)
        if bool_verbose:
            print("Inside get_user_input node - waiting for user input...")
    ...
    def route_after_input(state: AgentState) -> str:
        ...
        if state.get("user_input", "").strip() == "":
            if bool_verbose:
                print("Empty input detected. Asking for input again.")
